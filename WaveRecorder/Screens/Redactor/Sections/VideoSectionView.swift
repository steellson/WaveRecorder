...
final class VideoSectionView: UIView {
    ...
    func configureAppereanceWith(
        backgroundColor: UIColor,
        shadowColor: UIColor,
        videoPlayerHeight: CGFloat
    ) {
        setupContentView()
        setupContainerView(
    ...
    //MARK: Actions
    @objc private func contanierViewDidTapped() {
        guard !videoIsNotSelectedTitle.isHidden else { return }

        animateContainerViewOnTap()
    }

    @objc private func videoPlayerViewDidTapped() {
...
private extension VideoSectionView {
    ...
    func animateProgressWith(elapsedTime: String, remainingTime: String) {
